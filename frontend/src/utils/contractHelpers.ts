...
import chonkAbi from 'config/abi/chonk.json'
...
export const getChonkContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(chonkAbi, tokens.chonk.address, signer)
}
